...

{
  ...
  "overview": "## 项目定位\\n\\n阐述这个项目在 AI 生态中的位置（2-3段）。\\n- 它属于哪个赛道？解决什么核心问题？\\n- 目标用户是谁？为什么他们需要这个项目？\\n- 社区活跃度如何？由哪个团队/公司驱动？\\n\\n## 竞品对比\\n\\n与 2-3 个同类项目对比（功能、性能、社区、易用性），指出它的差异化优势。",
  "architecture": "## 整体架构\\n\\n深度分析项目的技术架构（3-5段）：\\n\\n1. **分层架构**：描述系统的分层设计（如 API 层、核心引擎层、存储层等），每层职责是什么\\n2. **核心数据流**：数据/请求如何在系统中流转，关键的处理节点有哪些\\n3. **模块组织**：代码仓库的目录结构和模块划分逻辑\\n4. **设计模式**：项目采用了哪些关键设计模式？（如工厂模式、策略模式、管道模式等）\\n5. **扩展机制**：项目如何支持插件/扩展？第三方如何贡献？\\n\\n如果没有足够信息，基于你对类似项目的了解进行合理推断。",
